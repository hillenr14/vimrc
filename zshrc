...
__conda_setup="$('/Users/hillenr/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/hillenr/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/hillenr/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/hillenr/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export ZSH="/Users/hillenr/.oh-my-zsh"
...
POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND='silver'
